...
contract DeployMoodNftTest is Test {
    ...
    function testConvertSvgToImageUri() public view {
        string
            memory expectedUri = "data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSI1MDAiIGhlaWdodD0iNTAwIj48dGV4dCB4PSIwIiB5PSIxNSIgZmlsbD0iYmxhY2siPiBIaSEgWW91IGRlY29kZWQgdGhpcyE8L3RleHQ+PC9zdmc+";
        string
